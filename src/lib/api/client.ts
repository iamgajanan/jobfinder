...
export const api = {
  ...
  searchJobs: (payload: JobSearchRequest) =>
    request<JobSearchResponse>("/jobs/search", { method: "POST", body: JSON.stringify(payload) }),

  plans: () => request<PlansResponse>("/plans"),

  createOrder: (payload: CreateOrderRequest) =>
    request<CreateOrderResponse>("/payments/orders", { method: "POST", body: JSON.stringify(payload) }),
